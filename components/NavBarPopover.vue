  ...
  <div class="w-full max-w-sm">
    <Popover v-slot="{ open }" class="relative">
      <PopoverButton
          ...
          class="inline-flex items-center px-3 py-2 text-base font-medium rounded-md group hover:text-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
      >
        <span>Services</span>
        <ChevronDownIcon
      ...
      >
        <PopoverPanel
            class="absolute z-10 w-96 max-w-sm max-w-md max-w-lg max-w-xl px-4 mt-3 transform -translate-x-1/2 left-1/2 sm:px-0 lg:max-w-3xl"
        >
          <div
